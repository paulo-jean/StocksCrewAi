...
#@tool    # usando tool decorator, obs. eu que fiz assim para testar e funcionou!
# def fetch_stock_price(ticket):
#     '''Fetches stocks prices for {ticket} froom the last year about a specific company from Yahoo Finance API'''
...
if submit_button:
    if not topic:
        ...
        results = crew.kickoff({'ticket': topic})
